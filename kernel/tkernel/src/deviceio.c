 ...
 */
SYSCALL ID tk_rea_dev_impl( ID dd, W start, VP buf, W size, TMO tmout )
{
	ER	ercd;
 ...
 */
SYSCALL ER tk_srea_dev_impl( ID dd, W start, VP buf, W size, W *asize )
{
	ER	ercd, ioercd;
 ...
 */
SYSCALL ID tk_wri_dev_impl( ID dd, W start, VP buf, W size, TMO tmout )
{
	ER	ercd;

	ercd = knl_request(dd, start, buf, size, tmout, TDC_WRITE);
 ...
 */
SYSCALL ER tk_swri_dev_impl( ID dd, W start, VP buf, W size, W *asize )
{
	ER	ercd, ioercd;
