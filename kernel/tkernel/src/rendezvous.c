 ...
 */
EXPORT WSPEC knl_wspec_cal_tfifo = { TTW_CAL, NULL, NULL };
EXPORT WSPEC knl_wspec_cal_tpri  = { TTW_CAL, cal_chg_pri, NULL };
#endif /* USE_FUNC_WSPEC_CAL */

#ifdef USE_FUNC_WSPEC_RDV
EXPORT WSPEC knl_wspec_rdv       = { TTW_RDV, NULL, NULL };
...
LOCAL WSPEC knl_wspec_acp       = { TTW_ACP, NULL, NULL };
